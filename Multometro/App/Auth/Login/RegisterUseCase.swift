...
protocol RegisterCaseProtocol: BaseUseCase {
    func register(email: String, password: String) -> Observable<NetworkingState<MultometroUser>>
}

final class RegisterUseCase: RegisterCaseProtocol {
